/**
 * Gemini API key pool — rotates between keys when one hits rate limits.
 * Keys: GEMINI_API_KEY (primary), GEMINI_API_KEY_2, GEMINI_API_KEY_3, ...
 */
...
function loadKeys() {
  ...
  // Load GEMINI_API_KEY_2, _3, _4, etc.
  for (let i = 2; i <= 10; i++) {
